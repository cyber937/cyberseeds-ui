    ...
    <div className="flex gap-1 items-center">
      <button
        ...
        className={clsx(
          ...
          checked ? `${colorMap[color]} disabled:bg-amber-100` : 'bg-gray-300 disabled:bg-gray-200'
        )}
        {...props}
      >
        <div
      ...
      <label className={clsx(`font-sans ${labelScaleMap[scale]}`, disabled ? 'text-gray-400' : 'text-black')}>
