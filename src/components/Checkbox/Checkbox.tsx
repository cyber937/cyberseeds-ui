...
export function Checkbox({ scale = 'md', color = 'red', label = 'checkbox', ...props }: CheckboxProps) {
  ...
  const colorMaps: Record<Color, string> = {
    ...
    orange: "checked:border-orange-600 checked:bg-orange-600 indeterminate:border-orange-600 indeterminate:bg-orange-600 focus-visible:outline-orange-600",
    amber: "checked:border-amber-600 checked:bg-amber-600 indeterminate:border-amber-600 indeterminate:bg-amber-600 focus-visible:outline-amber-600",
    yellow: "checked:border-yellow-600 checked:bg-yellow-600 indeterminate:border-yellow-600 indeterminate:bg-yellow-600 focus-visible:outline-yellow-600",
    ...
    green: "checked:border-green-600 checked:bg-green-600 indeterminate:border-green-600 indeterminate:bg-green-600 focus-visible:outline-green-600",
    emerald: "checked:border-emerald-600 checked:bg-emerald-600 indeterminate:border-emerald-600 indeterminate:bg-emerald-600 focus-visible:outline-emerald-600",
    ...
    indigo: "checked:border-indigo-600 checked:bg-indigo-600 indeterminate:border-indigo-600 indeterminate:bg-indigo-600 focus-visible:outline-indigo-600",
    violet: "checked:border-violet-600 checked:bg-violet-600 indeterminate:border-violet-600 indeterminate:bg-violet-600 focus-visible:outline-violet-600",
    purple: "checked:border-purple-600 checked:bg-purple-600 indeterminate:border-purple-600 indeterminate:bg-purple-600 focus-visible:outline-purple-600",
    fuchsia: "checked:border-fuchsia-600 checked:bg-fuchsia-600 indeterminate:border-fuchsia-600 indeterminate:bg-fuchsia-600 focus-visible:outline-fuchsia-600",
    ...
    slate: "checked:border-slate-600 checked:bg-slate-600 indeterminate:border-slate-600 indeterminate:bg-slate-600 focus-visible:outline-slate-600",
    ...
    neutral: "checked:border-neutral-600 checked:bg-neutral-600 indeterminate:border-neutral-600 indeterminate:bg-neutral-600 focus-visible:outline-neutral-600",
    stone: "checked:border-stone-600 checked:bg-stone-600 indeterminate:border-stone-600 indeterminate:bg-stone-600 focus-visible:outline-stone-600",
  }
  ...
  return (
    <div className={`flex ${gapScaleMap[scale]}`}>
      ...
      <div className="text-sm/6">
        <label className={`font-sans ${textScaleMap[scale]}`}>
          {label}
        </label>
      </div>
    </div >
