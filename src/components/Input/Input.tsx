  ...
  return (
    <div>
      ...
      <input
        ...
        style={customStyle}
        className={`cs:w-full cs:items-center cs:rounded-md cs:dark:text-gray-200 cs:disabled:bg-amber-100 cs:disabled:text-gray-400 cs:font-sans cs:outline-1 cs:placeholder:text-gray-400 cs:focus:outline-2 cs:focus:-outline-offset-2 cs:self-start cs:transition-colors cs:duration-200 cs:ease-in-out ${mergedInvalid
          ...
          } ${scaleMap[mergedScale]} ${isPresetColor(finalUIColor) ? focusOutlineColorMap[finalUIColor] : "cs-custom-focus"
          } ${className}`}
        {...props}
      />
    </div>
