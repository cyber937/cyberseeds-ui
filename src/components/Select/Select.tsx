  ...
  return (
    <div className="cs:flex cs:min-w-0">
      <select
        ...
        className={`cs:min-w-0 cs:appearance-none cs:rounded-md cs:border-gray-300 cs:dark:text-gray-400 cs:dark:bg-gray-800 cs:font-sans ${FOCUS_RING_INSET} cs:border-1 cs:disabled:bg-gray-300
          ${mergedInvalid
