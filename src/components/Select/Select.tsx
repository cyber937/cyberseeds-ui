...
export function Select({ scale = "md", isInvalid = false, children, id: externalId, ...props }: SelectProps) {
  ...
  return (
    <div className="cs:flex cs:min-w-0">
      <select
        id={id}
        aria-invalid={mergedInvalid || undefined}
        aria-describedby={describedBy}
        disabled={mergedDisabled || undefined}
        className={`cs:shadow-none cs:border-0 cs:min-w-0 cs:appearance-none cs:rounded-md cs:outline-1 cs:-outline-offset-1 cs:outline-gray-300 cs:dark:outline-gray-600 cs:dark:text-gray-400 cs:dark:bg-gray-800 cs:font-sans ${FOCUS_RING_INSET} cs:disabled:bg-gray-300 cs:dark:disabled:bg-gray-700 cs:dark:disabled:text-gray-500
          ${mergedInvalid
