"use client";
import{j as e}from"./iframe-DszvCNP2.js";import{T as s}from"./TextArea-Bvrb384V.js";import"./preload-helper-CJpEdZxZ.js";import"./colorMap-B4H6m5kb.js";import"./colorUtils-BF1Ih5IA.js";import"./designTokens-oNQ9a2iE.js";import"./FormFieldContext-TpYHAaEw.js";import"./Label-DBOsNz8O.js";import"./clsx-BYFsuUQf.js";import"./useUIColor-_6l39SGF.js";const k={component:s,title:"System/TextArea",tags:["autodocs"],argTypes:{label:{control:{type:"text"}},scale:{control:{type:"radio"},options:["xs","sm","md","lg"]},color:{control:{type:"select"},options:["red","orange","amber","yellow","lime","green","emerald","teal","cyan","sky","blue","indigo","violet","purple","fuchsia","pink","gray","zinc","neutral","stone"]},isInvalid:{control:{type:"boolean"}},disabled:{control:{type:"boolean"}}}},a={args:{label:"Text Area",scale:"md",color:"blue",require:!1,isInvalid:!1,disabled:!1}},r={args:{label:"Text Area",scale:"md",color:"blue",require:!0,isInvalid:!1,disabled:!1}},l={args:{label:"Text Area",scale:"md",color:"blue",require:!1,isInvalid:!0,disabled:!1}},c={args:{label:"Text Area",scale:"md",color:"blue",require:!1,isInvalid:!1,disabled:!0}},t={render:()=>e.jsxs("div",{className:"cs:grid cs:grid-cols-4 cs:gap-6",children:[e.jsxs("div",{children:[e.jsx("p",{className:"cs:text-xs cs:text-gray-500 cs:mb-2",children:"Extra Small (xs)"}),e.jsx(s,{label:"コメント",scale:"xs",placeholder:"入力してください",rows:3})]}),e.jsxs("div",{children:[e.jsx("p",{className:"cs:text-xs cs:text-gray-500 cs:mb-2",children:"Small (sm)"}),e.jsx(s,{label:"コメント",scale:"sm",placeholder:"入力してください",rows:3})]}),e.jsxs("div",{children:[e.jsx("p",{className:"cs:text-xs cs:text-gray-500 cs:mb-2",children:"Standard (md)"}),e.jsx(s,{label:"コメント",scale:"md",placeholder:"入力してください",rows:3})]}),e.jsxs("div",{children:[e.jsx("p",{className:"cs:text-xs cs:text-gray-500 cs:mb-2",children:"Large (lg)"}),e.jsx(s,{label:"コメント",scale:"lg",placeholder:"入力してください",rows:3})]})]})};var o,n,d;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    label: "Text Area",
    scale: "md",
    color: "blue",
...
}`,...(d=(n=a.parameters)==null?void 0:n.docs)==null?void 0:d.source}}};var i,m,p;r.parameters={...r.parameters,docs:{...(i=r.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    label: "Text Area",
    scale: "md",
    color: "blue",
...
}`,...(T=(h=t.parameters)==null?void 0:h.docs)==null?void 0:T.source}}};const L=["Default","Require","Invalid","Disabled","Scales"];export{a as Default,c as Disabled,l as Invalid,r as Require,t as Scales,L as __namedExportsOrder,k as default};
