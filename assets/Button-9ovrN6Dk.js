"use client";
import{r as s,j as r,R as g}from"./iframe-BH6SszEl.js";import{L as f}from"./colorContrast-C0ZIkquj.js";import{a as x,i as b,c as h}from"./colorUtils-CzaG3QqU.js";import{c as w,F as C}from"./designTokens-DumaUFqK.js";import{u as N}from"./useUIColor-ByGmMwax.js";const i=s.createContext(null),k={xs:"cs:px-1.5 cs:py-0.5 cs:text-[0.625rem] cs:h-5 cs:max-md:min-h-11",sm:"cs:px-2 cs:py-1 cs:text-xs cs:h-6 cs:max-md:min-h-11",md:"cs:px-3 cs:py-1.5 cs:text-sm/6 cs:h-9 cs:max-md:min-h-11",lg:"cs:px-4 cs:py-2 cs:text-base cs:h-11"};function o({scale:a="md",variant:e="primary",color:l="blue",children:c,className:m="",...u}){const{color:d}=N()??{color:void 0},n=x(d??l),t=b(n)&&f.has(n)?"cs:text-gray-900":"cs:text-white cs:dark:text-gray-200",p=s.useMemo(()=>({primary:`${t} cs:disabled:text-gray-500 cs-btn-primary`,secondary:"cs:dark:text-gray-400 cs:ring-gray-500/80 cs:ring-1 cs:ring-inset cs:text-black cs:hover:bg-gray-400 cs:active:bg-gray-300 cs:dark:hover:bg-gray-600 cs:dark:active:bg-gray-500"}),[t]),v=e==="primary"?h(n):void 0,y=s.useMemo(()=>({scale:a}),[a]);return r.jsx(i.Provider,{value:y,children:r.jsx("button",{style:v,className:`cs:border-0 cs:shadow-none cs:inline-flex cs:items-center cs:rounded-md cs:font-sans cs:justify-center cs:font-semibold cs:cursor-pointer cs:w-fit cs:max-w-full cs:whitespace-nowrap cs:self-start cs:align-middle cs:gap-1.5 cs:active:scale-[0.97] cs:motion-reduce:active:scale-100 ${w} ${C} ${k[a]} ${p[e]} cs-focus-visible ${m}`,...u,children:c})})}const I={xs:"cs:size-3",sm:"cs:size-4",md:"cs:size-5",lg:"cs:size-6"};o.Icon=function({children:e}){const l=s.useContext(i);if(!l)throw new Error("Button.Icon must be used within a <Button>");return g.cloneElement(e,{className:`${e.props.className??""} ${I[l.scale]}`.trim()})};o.__docgenInfo={description:"",methods:[{name:"Icon",docblock:null,modifiers:["static"],params:[{name:`{
  children,
}: {
