"use client";
import{j as a}from"./iframe-BPlIpqzu.js";import{B as r}from"./Button-DFfM4GwJ.js";import{M as e}from"./Modal-DCHxLNVl.js";import"./useUIColor-DJw1Sg90.js";const p={component:e,title:"System/Modal",argTypes:{width:{control:{type:"radio"},options:["sm","md","lg"]}}},o={args:{width:"md"},render:t=>a.jsx("div",{className:"cs:h-full",children:a.jsxs(e,{...t,children:[a.jsx(e.Header,{children:"Modal"}),a.jsx(e.Body,{children:"Sample modal body sentencse."}),a.jsx(e.Footer,{children:a.jsxs("div",{className:"cs:flex cs:gap-2",children:[a.jsx(r,{variant:"secondary",children:"キャンセル"}),a.jsx(r,{children:"確定"})]})})]})})};var s,d,n;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    width: "md"
  },
